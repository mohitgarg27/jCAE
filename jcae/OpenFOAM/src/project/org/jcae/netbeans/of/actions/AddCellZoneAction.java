 ...
 * @author mogargaa65
 */
public class AddCellZoneAction extends CookieAction
{
    ...
    protected void performAction(Node[] activatedNodes) 
    {
        ...
        CellZonePanel a = new CellZonePanel(rNode.getrName(), pr);
        if(a.showDialog())
        {
            ...
            nColl.add(new CellZoneNode(a.params.getZoneName(), rNode.getrName(), pr));
